...
Env (billing): `POLAR_ACCESS_TOKEN`, `POLAR_WEBHOOK_SECRET`, `POLAR_API_BASE`,
and the Builder plan product/cap pairs:
`POLAR_BUILDER_STARTER_PRODUCT_ID` / `POLAR_BUILDER_STARTER_CAP_SECONDS`,
`POLAR_BUILDER_STUDIO_PRODUCT_ID` / `POLAR_BUILDER_STUDIO_CAP_SECONDS`,
`POLAR_BUILDER_SCALE_PRODUCT_ID` / `POLAR_BUILDER_SCALE_CAP_SECONDS`.
`POLAR_PRODUCT_ID` and `POLAR_PLAN_CAP_SECONDS` remain as Starter fallbacks for
older deploys.
...
- `POLAR_ACCESS_TOKEN`
- `POLAR_PRODUCT_ID`
- `POLAR_BUILDER_STARTER_PRODUCT_ID`
- `POLAR_BUILDER_STUDIO_PRODUCT_ID`
- `POLAR_BUILDER_SCALE_PRODUCT_ID`
- `POLAR_WEBHOOK_SECRET`
- `POLAR_PLAN_CAP_SECONDS`
- `POLAR_BUILDER_STARTER_CAP_SECONDS`
- `POLAR_BUILDER_STUDIO_CAP_SECONDS`
- `POLAR_BUILDER_SCALE_CAP_SECONDS`
