...
import { isAllowedPreviewHost } from "@/lib/polarSandbox";
...
export default async function PolarSandboxPage() {
  ...
  if (!isAllowedPreviewHost(host) || !builder.ok || !personal.ok || builder.mode !== "sandbox" || personal.mode !== "sandbox" || process.env.VERCEL_ENV !== "preview") notFound();
  return (
