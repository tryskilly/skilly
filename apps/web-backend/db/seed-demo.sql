-- Local/demo seed for the Skilly web backend dashboard.
--
-- Safe to run more than once. Mirrors src/db/memoryRepo.ts so local Postgres
-- behaves like the in-memory dev fallback.
